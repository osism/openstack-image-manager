...
class TestManage(TestCase):
    ...
    @mock.patch('openstack_image_manager.manage.openstack.image.v2._proxy.Proxy.remove_tag')
    @mock.patch('openstack_image_manager.manage.openstack.image.v2._proxy.Proxy.add_tag')
